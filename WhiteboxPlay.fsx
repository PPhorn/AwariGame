...
let rec play (b : board) (p : player) : board =
  if isGameOver b then
    ...
    let newB = boardtest10
    let nextP =
      if p = Player1 then
        Player2
      else
        Player1
    printfn "%A" (play newB nextP)
...
printfn "Branch 2a: if isGameOver = false. Exp. output: [|3; 3; 3; 3; 3; 3; 0; 3; 3; 3; 3; 3; 3; 0;|] - %b" (play boardtest10 Player2 = [|3; 3; 3; 3; 3; 3; 0; 3; 3; 3; 3; 3; 3; 0;|])
